...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "images/egg/2.png" })));
};
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #2973cf, 0px 0px 0px 4px #2973cf",
...
var links = [
    ...
    },
    {
        ...
        items: [
            {
                label: "Exchange",
                href: "https://exchange.conquerswap.finance",
            },
            {
                label: "Liquidity",
                href: "https://exchange.conquerswap.finance/#/pool",
            },
        ],
    },
    {
...
var socials = [
    {
        ...
        items: [
            ...
            {
                label: "Announcements",
                href: "https://t.me/conquerswapannouncements",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/ConquerSwap",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: '#004293', textDisabled: '#adc1c9', textSubtle: '#0e58b3', borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
